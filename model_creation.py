...
merged_data = pd.read_csv("C:/Users/huffm/merged_data.csv", index_col = 0)
...
# Fill in missing values with preceeding value
...
print(df_results.loc[:, ['Rate_forecast', 'coronavirus_forecast', 'distancing_forecast', 'hygiene_forecast', 'masks_forecast']])
